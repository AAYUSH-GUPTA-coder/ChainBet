      ...
      <div className="  font-mont px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pt-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-white md:text-lg">
            Behind ChainBet is an amazing team of developers who love Web3 and
            try to build a better, decentralized Web.
          </p>
        </div>
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                ...
                <p className="mb-4 text-xs tracking-wide text-gray-400">
                  Developed all the Smart Contracts. Brain behind the Idea.
                </p>
          ...
          <div>
            <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
              ...
              />
              <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                <p className="mb-1 text-lg font-bold text-gray-100">Harsh</p>
                <p className="mb-4 text-xs text-gray-100">
                  Frontend and integration
                </p>
                <p className="mb-4 text-xs tracking-wide text-gray-400">
                  Focused on integrating the logic in the Frontend.
                </p>
                <div className="flex items-center justify-center space-x-3">
                  <a
                    className="text-white transition-colors duration-300 hover:text-teal-accent-400"
                    href="https://twitter.com/0xharsh1001"
                    target={"_blank"}
                    rel="noreferrer"
                  >
                    <svg
                  ...
                  <a
                    className="text-white transition-colors duration-300 hover:text-teal-accent-400"
                    href="https://github.com/Saviour1001"
                    target={"_blank"}
                    rel="noreferrer"
                  >
                    <svg
          ...
          <div>
            <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                ...
                <p className="mb-4 text-xs tracking-wide text-gray-400">
                  Worked on the Frontend and implemented the UI/UX Design
                </p>
                <div className="flex items-center justify-center space-x-3">
                  <a
                    className="text-white transition-colors duration-300 hover:text-teal-accent-400"
